...
export default function SettingsPage({ userEmail, onAccountDeleted }: SettingsPageProps) {
  ...
  // Extract section contents for reusability
  ...
  const EmailPreferencesSectionContent = () => (
  ...
  const DangerZoneSectionContent = () => (
    <div className="space-y-4">
  ...
  return (
    <div className="space-y-8 text-left animate-fade-in">
      ...
      {/* Security Section - CollapsibleSection on mobile/tablet, inline on desktop */}
      <CollapsibleSection 
        title="Security" 
        icon={Lock}
        defaultOpen={false}
      ...
      {/* Email Preferences Section - CollapsibleSection on mobile/tablet, inline on desktop */}
      <CollapsibleSection 
        title="Email Preferences" 
        icon={Mail}
        defaultOpen={false}
      >
        <EmailPreferencesSectionContent />
      </CollapsibleSection>

      {/* Danger Zone Section - CollapsibleSection on mobile/tablet, inline on desktop */}
      <CollapsibleSection 
        title="Danger Zone" 
        icon={AlertCircle}
        defaultOpen={false}
