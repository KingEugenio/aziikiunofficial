...
export default function NotFoundPage({ onGoHome }: NotFoundPageProps) {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-4 font-sans">
      <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-8 sm:p-10 shadow-sm max-w-md w-full text-center space-y-5">
        <BrandLogo size={44} className="mx-auto" />
        <div>
          <p className="text-5xl font-black text-slate-200 tracking-tight leading-none mb-2">404</p>
          <h1 className="text-lg font-black text-slate-900 dark:text-slate-100">Page not found</h1>
