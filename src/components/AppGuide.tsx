...
export default function AppGuide() {
    ...
    <>
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs leading-relaxed">
                <div className="space-y-3.5">
                  <h4 className="font-extrabold text-slate-900 dark:text-slate-100 uppercase tracking-wider text-[10px] font-mono text-indigo-600 dark:text-indigo-400 flex items-center gap-1.5">
                    <Globe className="w-3.5 h-3.5 shrink-0" /> Cultural Origin & Meaning
                  </h4>
                  <p className="text-slate-600 dark:text-slate-300 font-light">
                    <strong className="font-semibold text-slate-900 dark:text-slate-100">Aziiki</strong> is inspired by the <strong className="font-semibold text-slate-950 dark:text-slate-50">Hausa word "arziki"</strong>, spoken across West Africa and widely understood well beyond it.
                  </p>

                  {/* Pronunciation & Phonetic Breakdown Card */}
                  <div className="bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-3.5 space-y-2">
                    <span className="text-[9px] font-mono font-bold text-indigo-600 dark:text-indigo-400 uppercase tracking-widest flex items-center gap-1.5">
                      <Microphone className="w-3 h-3 shrink-0" /> How to Pronounce It
                    </span>
                    <div className="flex flex-wrap items-baseline gap-2">
                      <span className="text-sm font-extrabold text-slate-900 dark:text-slate-100">/ah-ZEE-kee/</span>
                      <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400 font-mono">"ah-ZEE-kee"</span>
                    </div>
                    <p className="text-[10.5px] text-slate-500 dark:text-slate-400 font-light leading-normal">
                      Open with a relaxed <strong className="font-semibold text-slate-700 dark:text-slate-300">"ah"</strong> (like in "father"), land firmly on the stressed middle syllable <strong className="font-medium text-slate-800 dark:text-slate-200">"ZEE"</strong>, then close softly with <strong className="font-medium text-slate-800 dark:text-slate-200">"kee."</strong>
                    </p>
                  </div>

                  <p className="text-slate-600 dark:text-slate-300 font-light">
                    "Arziki" means <strong className="font-semibold text-slate-900 dark:text-slate-100">wealth, riches, and prosperity</strong>. It reflects our vision of helping entrepreneurs not only manage their businesses, but understand, protect, and grow the wealth they create.
                  </p>
                  <p className="text-slate-600 dark:text-slate-300 font-light">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-xs font-sans">
                  <div className="p-3.5 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-1">
                    ...
                    <strong className="text-slate-900 dark:text-slate-100 block pt-1">Settings Profile</strong>
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">Click Edit in the sidebar to define your home currency, business legal structure, and custom brand logo.</p>
                  </div>
                  <div className="p-3.5 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-1">
                    ...
                    <strong className="text-slate-900 dark:text-slate-100 block pt-1">Fill the Warehouse</strong>
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">Log your product stocks, cost pricing, and safety stock levels inside the Warehouse module.</p>
                  </div>
                  <div className="p-3.5 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-1">
                    ...
                    <strong className="text-slate-900 dark:text-slate-100 block pt-1">Seed Your Ledger</strong>
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">Enter 2-3 recent sale records or expense items to see your dynamic cash flow metrics update.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeChapter === "scorecard" && isEnabled("core_dashboard") && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4 text-xs leading-relaxed">
                <p className="text-slate-600 dark:text-slate-300 font-light">
                  The <strong className="font-semibold text-slate-900 dark:text-slate-100">Cash Scorecard</strong> is the financial dashboard of your enterprise. It acts as the ultimate digital cash drawer, representing how capital rolls through your daily operations.
                </p>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-2">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">
                ...
                <div className="space-y-3.5">
                  ...
                  <ul className="space-y-2.5 list-disc pl-5 text-slate-600 dark:text-slate-300 font-light">
                    <li>
          ...
          {activeChapter === "billing" && isEnabled("core_billing") && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4 text-xs leading-relaxed">
                <p className="text-slate-600 dark:text-slate-300 font-light">
                  A professional client experience accelerates invoice payment turnaround. The <strong className="font-semibold text-slate-900 dark:text-slate-100">Billing Desk</strong> replaces expensive billing systems, compiling standard-compliant billing files that render beautifully on mobile screens.
                </p>

                <div className="border border-slate-100 dark:border-slate-700 rounded-2xl overflow-hidden">
                  <div className="bg-slate-50 dark:bg-slate-900 p-3 font-mono text-[9px] uppercase tracking-wider font-bold text-slate-400 border-b border-slate-100 dark:border-slate-700">
                    Document Flow Lifecycle
                  </div>
                  <div className="p-4 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center font-sans">
                    <div className="space-y-1">
                      <span className="text-xs font-bold text-slate-900 dark:text-slate-100 block">1. Draft Estimate</span>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 font-light">Issue an itemized bid with a defined expiry date. Great for securing initial customer agreements before purchasing inventory.</p>
                    </div>
                    <div className="space-y-1 border-t sm:border-t-0 sm:border-l border-slate-100 dark:border-slate-700 pt-3 sm:pt-0 sm:pl-4">
                      <span className="text-xs font-bold text-slate-900 dark:text-slate-100 block">2. Official Invoice</span>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 font-light">Confirm the transaction with itemized VAT or custom regional tax settings. Triggers active receivables tracking inside the CRM.</p>
                    </div>
                    <div className="space-y-1 border-t sm:border-t-0 sm:border-l border-slate-100 dark:border-slate-700 pt-3 sm:pt-0 sm:pl-4">
                      <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 block">3. Payment Slip</span>
                      <p className="text-[11px] text-slate-500 dark:text-slate-400 font-light">Mark as paid to generate a print-ready receipt. This automatically reduces linked safety stock counts in your inventory database.</p>
                    </div>
                  </div>
                </div>
          ...
          {activeChapter === "inventory" && isEnabled("inventory_management") && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-5 text-xs leading-relaxed">
                <p className="text-slate-600 dark:text-slate-300 font-light">
                  Capital can become locked up inside physical shelves in the form of sitting inventory. The <strong className="font-semibold text-slate-900 dark:text-slate-100">Smart Warehouse</strong> helps you monitor stock values and alerts you when critical items are running dry.
                </p>

                {/* INTERACTIVE COMPONENT: SME PRODUCT MARGIN CALCULATOR */}
                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 space-y-4">
                  <div className="flex items-center gap-2">
                    <TrendingUp className="w-4.5 h-4.5 text-indigo-600 dark:text-indigo-400" />
                    <span className="text-xs font-black text-slate-900 dark:text-slate-100 uppercase tracking-wider font-sans">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest block">Unit Wholesale Cost</label>
                      <input
                        type="number"
                        value={marginCost}
                        onChange={(e) => setMarginCost(Math.max(0, Number(e.target.value)))}
                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 outline-none font-mono text-xs text-slate-900 dark:text-slate-100"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest block">Unit Retail Price</label>
                      <input
                        type="number"
                        value={marginPrice}
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-700 grid grid-cols-3 gap-2 text-center">
                    <div>
                      <span className="text-[8px] font-mono font-bold text-slate-400 uppercase block">Net Profit Margin</span>
                      <strong className="text-emerald-600 dark:text-emerald-400 font-mono text-sm block mt-1">
                    ...
                    <div>
                      ...
                      <strong className="text-indigo-600 dark:text-indigo-400 font-mono text-sm block mt-1">
                  ...
                  {grossMarginPercent < 35 && (
                    <p className="text-[10px] text-amber-600 dark:text-amber-400 bg-amber-500/10 border border-amber-500/20 rounded-xl p-2 font-sans font-light italic leading-snug flex items-start gap-1.5">
              ...
              <div className="space-y-5 text-xs leading-relaxed">
                ...
                <div className="bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div className="space-y-1">
                      <label className="text-[9px] font-mono font-bold text-slate-400 uppercase block">Total Reserve Capital</label>
                      <input
                        type="number"
                        step="1000"
                        value={ladderCapital}
                        onChange={(e) => setLadderCapital(Math.max(1000, Number(e.target.value)))}
                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-2.5 py-1.5 outline-none font-mono text-xs text-slate-900 dark:text-slate-100"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[9px] font-mono font-bold text-slate-400 uppercase block">Number of Ladder Stages</label>
                      <select
                        value={ladderStages}
                        onChange={(e) => setLadderStages(Number(e.target.value))}
                        className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-2.5 py-1.5 outline-none text-xs text-slate-900 dark:text-slate-100"
                      >
                    ...
                    <div className="space-y-1">
                      <label className="text-[9px] font-mono font-bold text-slate-400 uppercase block">Expected Yield (% APY)</label>
                      <input
                        type="number"
                        step="0.1"
                        value={ladderYield}
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-xl p-3 border border-slate-100 dark:border-slate-700 space-y-3.5">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-center text-xs">
                      <div className="border-r border-slate-100 dark:border-slate-700">
                        ...
                        <strong className="text-slate-900 dark:text-slate-100 font-mono text-xs block mt-0.5">${stageCapital.toLocaleString(undefined, { maximumFractionDigits: 0 })}</strong>
                      </div>
                      <div className="border-r border-slate-100 dark:border-slate-700">
                        <span className="text-[8px] font-mono text-slate-400 block uppercase">Maturity Cycles</span>
                        <strong className="text-slate-900 dark:text-slate-100 font-mono text-xs block mt-0.5">Every {stageMaturityDays} Days</strong>
                      </div>
                      <div className="border-r border-slate-100 dark:border-slate-700">
                        <span className="text-[8px] font-mono text-slate-400 block uppercase">Stage Cycle Profit</span>
                        <strong className="text-emerald-600 dark:text-emerald-400 font-mono text-xs block mt-0.5">+${cycleInterestPerStage.toLocaleString(undefined, { maximumFractionDigits: 2 })}</strong>
                      </div>
                      <div>
                        <span className="text-[8px] font-mono text-slate-400 block uppercase">Annual Net Profit</span>
                        <strong className="text-emerald-600 dark:text-emerald-400 font-mono text-xs block mt-0.5">+${(annualInterestPerStage).toLocaleString(undefined, { maximumFractionDigits: 0 })}</strong>
                      </div>
                    </div>
                    ...
                    <div className="pt-2 border-t border-slate-100 dark:border-slate-700">
                      ...
                      <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                        {Array.from({ length: ladderStages }).map((_, idx) => {
                          ...
                          return (
                            <div key={idx} className="bg-slate-50 dark:bg-slate-900 p-2 border border-slate-200 dark:border-slate-700 rounded-lg text-center font-sans space-y-0.5">
                              <span className="text-[8px] font-mono font-bold text-indigo-600 dark:text-indigo-400 block uppercase">T-Bill {idx + 1}</span>
                              <strong className="text-[10px] text-slate-900 dark:text-slate-100 block font-mono">${stageCapital.toLocaleString(undefined, { maximumFractionDigits: 0 })}</strong>
                              <span className="text-[8px] text-slate-400 block">Matures Day: {delayDays}</span>
                            </div>
                          );
                        })}
                      </div>
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4 text-xs leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-2">
                    <h5 className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5 text-xs">
                      <CurrencyCircleDollar className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
              ...
              <div className="space-y-4 text-xs leading-relaxed">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-4 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-2">
                    <h5 className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5 text-xs">
                      <ClipboardText className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
                      Purchase Orders
                    </h5>
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">
                  ...
                  <div className="p-4 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-2">
                    <h5 className="font-bold text-slate-900 dark:text-slate-100 flex items-center gap-1.5 text-xs">
                      <UsersThree className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                      Team & Roles
                    </h5>
                    <p className="text-slate-500 dark:text-slate-400 text-[11px] font-light">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4 text-xs leading-relaxed">
                ...
                <p className="text-slate-600 dark:text-slate-300 font-light">
                  ...
                  <strong className="font-semibold text-slate-900 dark:text-slate-100">Business Health Score</strong> on your Scorecard is
          ...
          {activeChapter === "ai" && isEnabled("core_ai_advisor") && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-5 text-xs leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border border-slate-100 dark:border-slate-700 rounded-2xl space-y-2 text-left">
                    <span className="text-xs font-bold text-slate-900 dark:text-slate-100 block flex items-center gap-1.5">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 text-slate-600 dark:text-slate-300">
                  <span className="font-bold text-amber-700 dark:text-amber-400 uppercase text-[9px] font-mono tracking-wider flex items-center gap-1.5 mb-1">
          ...
          {activeChapter === "playbooks" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-6 text-xs leading-relaxed">
                ...
                {/* Playbook A */}
                <div className="space-y-2.5 p-4 bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 rounded-2xl">
                  <h5 className="font-extrabold text-slate-900 dark:text-slate-100 flex items-center gap-1.5 text-xs">
                  ...
                  <ol className="space-y-1.5 list-decimal pl-5 text-[11px] text-slate-600 dark:text-slate-300 font-light">
  ...
  return (
    <div id="app-guide-academy" className="space-y-8 text-slate-800 dark:text-slate-200 font-sans pb-12 select-none animate-fade-in text-left">
      {/* Scroll progress bar */}
      ...
      <div className="bg-brand-teal text-white rounded-3xl p-6 sm:p-8 shadow-md">
        <div className="max-w-3xl space-y-3">
          <span className="bg-white/20 dark:bg-slate-800/20 text-white border border-white/30 text-[10px] font-mono tracking-widest uppercase font-black px-3 py-1 rounded-full inline-block">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-4.5 space-y-2 shadow-sm shrink-0">
          <span className="text-[9px] font-mono font-bold text-slate-400 uppercase tracking-widest block px-2.5 pb-2 border-b border-slate-100 dark:border-slate-700">
            Academy Syllabus
          </span>
 ...
 : "hover:bg-slate-50 hover:dark:bg-slate-900 text-slate-600 dark:text-slate-300"
 }`}
                  >
                    ...
                    <span className={`text-[10px] font-light ${active ? "text-emerald-100 text-emerald-200" : "text-slate-400"}`}>
                      {chapter.desc}
                    </span>
                  </button>
                  ...
                  {active && <div className="lg:hidden bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-4 sm:p-5 shadow-sm space-y-6 mb-1 animate-fade-in">{activeChapterContent}</div>}
                </React.Fragment>
              );
            })}
          </nav>
        ...
        <div className="hidden lg:block lg:col-span-9 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">{activeChapterContent}</div>
      </div>

      {/* Footer support block */}
      <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-xs text-left space-y-1">
          <strong className="text-slate-900 dark:text-slate-100 block font-sans">Have questions about bookkeeping or investments?</strong>
        ...
        <div className="flex items-center gap-2 font-mono text-[10px] text-indigo-600 dark:text-indigo-400 font-black shrink-0">
