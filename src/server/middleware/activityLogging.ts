...
import { isFeatureFlagOn } from "../featureFlagCheck";
 ...
 * Gated by the activity_monitoring_enabled flag (admin portal -> Feature
 * Flags) - off by default, and when off this does none of the
 * response-wrapping below, not just skip the eventual DB write.
 */
